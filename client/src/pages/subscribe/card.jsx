...
function Card(props){
    ...
    return (
        <div className="Card h-64 sm:h-5/6 w-64 relative border-2 group bg-amber-400 dark:bg-orange-900 border-white overflow-hidden
                    rounded-md flex flex-col py-10 sm:py-16 px-3 sm:px-10 text-white sm:text-amber-400 sm:dark:text-orange-900 font-extrabold"
            ...
            <h1 className="z-10 text-3xl text-white group-hover:text-amber-400 dark:group-hover:text-orange-900 
                        transition-colors">{props.package.name}</h1>
